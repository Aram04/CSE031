...
// DO NOT change the definition of the printArr function when it comes to // adding/removing/modifying the function parameters, or changing its return // type.
...
int main(){
  ...
  if (size != 0) {
    ...
    printf("\n"); // Adding an extra newline here
  } else {
    printf("\n"); // Adding an extra newline if size is 0
  }
